...
//         var_dump($player);die();
    ...
    private function attackBoss(&$data, $player, PlayerBoss $boss) {
        ...
        /*
            ...
            Use $xp_awarded.
        */
        $player_attack = $player->attackPlayerBoss($boss, $stamina);
        $xp_awarded = $player_attack['xp'];
        $dmg_to_boss = $player_attack['damage'];
        $dmg_to_player = 0;
        if($boss->isDead()) {
        ...
        $boss->log($dmg_to_player, $dmg_to_boss, $xp_awarded, $player);
