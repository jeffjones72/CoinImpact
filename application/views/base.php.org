<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.retrieve_item').click(function(e){
            items = parseInt($("#inventory-item-count").html()) + 1;
            stored = parseInt($("#storage-item-count").html()) - 1;
            id = $(this).attr('id');
...
<div style="display:block">
    ...
    <div class="baseStorage section" id="storage">
        ...
        <?php foreach($inventory_items as $p_item) { ?>
            <div class="large-slot" id="item-storage-<?=$p_item->id?>"<?php if(!$p_item->stored) {echo ' style="display:none;"'; } ?>>
                ...
                <table class="info">
                    ...
                    <div id="storage-<?=$p_item->id?>" class="retrieve_item">
                        Retrieve
                    </div>
            </div>
        <?php } ?>        
        <div id="storedEnd" class="clear"></div>
        <?php foreach($inventory_items as $p_item) {?>
            <div class="large-slot" id="item-storage-<?=$p_item->id?>"<?php if($p_item->stored) {echo ' style="display:none;"'; } ?>>
                <span class="largeTitle"><?=$p_item->item->name?></span>
                <img src="/_images/data/items/<?=$p_item->item->id?><?php if($p_item->item->has_quality){?>-<?=$p_item->quality?><?php }?>.png" height="92" width="165" alt="" />
                <table class="info">
                    ...
                    <div id="storage-<?=$p_item->id?>" class="store_item">
                        Store
                    </div>
            </div>
        <?php } ?>
        <div id="unstoredEnd" class="clear"></div>
    </div>	
...
<?php } ?>
    ...
    <div class="baseInventory section" id="inventory">			
        ...
        Things: <span id="inventory-thing-count"><?php echo sizeof($inventory_things);?></span></h2>
        <?php foreach($inventory_items as $p_item) { if(!$p_item->stored){?>
            <div class="large-slot" id="item-<?=$p_item->id?>"<?php if($p_item->stored) {echo ' style="display:none;"'; } ?>>
                <span class="largeTitle"><?=$p_item->item->name?></span>
                <img src="/_images/data/items/<?=$p_item->item->id?><?php if($p_item->item->has_quality){?>-<?=$p_item->quality?><?php }?>.png" height="92" width="165" alt="" />
                <table class="info">
                    <tr>
