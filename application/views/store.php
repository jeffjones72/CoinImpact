        ...
        <div class="premiumSalesSection">
            ...
            <div class="premiumInfoSection">
                ...
                <div class="premiumTextArea">
                    <p class="premiumInfoText">No need to wait for regeneration. Use the coins you have earned to refill your resources now, or buy powerful items to help you on your missions!</p>
                </div>
                ...
                <div class="premiumSaleBox">
                    ...
                    <h4 class="infoText">Full refill of your Stamina</h4>
                </div>
                ...
                <div class="premiumSaleBox">
                    <input style="float: right;" class="blueBtnS blue" type="submit" name="submit" value="BUY">
                    <h4 class="infoText">Purchase more Challenge Coins now and get 75% more while we are in Beta!</h4>
