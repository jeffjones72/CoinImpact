                ...
                <div>
                    <select name="points">
                        <?php for ($i = floor(1 / $stamina_rate); $i <= $player->skill; $i+=floor(1 / $stamina_rate)) { ?>
                            <option value="<?php echo $i * $stamina_rate; ?>"><?php echo $i * $stamina_rate; ?> Stamina Limit (<?php echo $i; ?> Skill Points)</option>
                        <?php } ?>
                    </select>
                ...
                <div>
                    <select name="points">
                        <?php for ($i = floor(1 / $energy_rate); $i <= $player->skill; $i+=floor(1 / $energy_rate)) { ?>
                            <option value="<?php echo $i * $energy_rate; ?>"><?php echo $i * $energy_rate; ?> Energy Limit (<?php echo $i; ?> Skill Points)</option>
                        <?php } ?>
                    </select>
                ...
                <div>
                    <select name="points">
                        <?php for ($i = 1; $i <= $player->skill; ++$i) { ?>
                            <option value="<?php echo $i * $health_rate; ?>"><?php echo $i * $health_rate; ?> Health Limit (<?php echo $i; ?> Skill Points)</option>
                        <?php } ?>
                    </select>
                ...
                <div>
                    <select name="points">
                        <?php for ($i = floor(1 / $attack_rate); $i <= $player->skill; $i+=floor(1 / $attack_rate)) { ?>
                            <option value="<?php echo $i * $attack_rate; ?>"><?php echo $i * $attack_rate; ?> Attack (<?php echo $i; ?> Skill Points)</option>
                        <?php } ?>
                    </select>
                ...
                <div>
                    <select name="points">
                        <?php for ($i = floor(1 / $defense_rate); $i <= $player->skill; $i+=floor(1 / $defense_rate)) { ?>
                            <option value="<?php echo $i * $defense_rate; ?>"><?php echo $i * $defense_rate; ?> Defense (<?php echo $i; ?> Skill Points)</option>
                        <?php } ?>
                    </select>
