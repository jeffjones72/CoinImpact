...
<div id="intro">
    ...
    <div class="introSection">
        <div id="popIntroSquad" class="popUp">
            ...
            <div class="left">
                <img src="<?php echo base_url(); ?>_images/squad/Portraits001MainPreview.jpg" height="100" alt="">
                <p align="center">Member 1</p>
            </div>
            <div class="left">
                <img src="<?php echo base_url(); ?>_images/squad/Portraits002SoldierTwoPreview.jpg" height="100" alt="">
                <p align="center">Member 2</p>
            </div>
            <div class="left">
                <img src="<?php echo base_url(); ?>_images/squad/Portraits003SoldierThreePreview.jpg" height="100" alt="">
                <p align="center">Member 3</p>
            </div>
